...
The pseudocode above uses `decisionType: "feature_gate_friction_evaluation"`, which is the correct approach — friction evaluation is a distinct decision type, not a subtype of conversion trigger evaluation. SI §9.2 amendment is needed (added under S8-ST-4). [S8-ST-4]

...
**Content Agent:** 1 of 6
**Generated:** 2026-02-15
**Upstream flags resolved:** S1-2, S1-8, S2-3, S3-7, S5-7, S6-5
**Decision types:** `quality_score_band_evaluation`
**Authoritative type source:** `QualityScore` (D&L §4), `QualityScoreChangedEvent` (D&L §1.8 / SI §1 `EventPayloadMap`), `DecisionLog` (SI §9.2)

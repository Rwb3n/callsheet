...
**Dependencies:** `00-schema.md` (`perception_aggregates` table), `01-decisions.md` (D1, D9, OQ-1), `01-router-plan.md` (§3 no dedicated route — analytics surfaces in S5 provider dashboard)

...
**Slice:** S7 (Operations)
**Phase 2 output — content section**
**Inputs:** `operations.md` (v3) §1.3/§2/§7, `shared-infrastructure.md` (v6) §5.1–§5.2/§10, `commercial-and-revenue.md` (v3) §1.3, `data-and-listings.md` (v5) §1.7, `01-schema.md`, `01-router-plan.md`, `01-decisions.md`
...
sequenceDiagram
    ...
    alt activeSupportTicket present
        ...
        Ops->>Email: send("listing_decay_warning", mergeFields, "operations_compliance")

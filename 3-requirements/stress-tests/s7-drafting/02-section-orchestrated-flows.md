...
**Skeleton section:** §6
**Primary sources:** `shared-infrastructure.md` §3 (orchestrated flow engine), `decisions/sq-2.md` (skip constraint matrix), `01-schema.md` §3.1, `01-router-plan.md` §3.6, upstream flags S0-3, R11

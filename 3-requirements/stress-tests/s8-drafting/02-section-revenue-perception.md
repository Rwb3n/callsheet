...
**Agent:** D (Revenue Perception)
**Slice:** S8 Commercial & Revenue
**Written:** 2026-02-14
**Inputs:** `interfaces/commercial-and-revenue.md` (v3) §6, `2-concept-design/commercial-and-revenue.md` (v4) §6, `s8-drafting/01-schema.md`, `s8-drafting/01-router-plan.md`, `s8-drafting/01-decisions.md` (D4), `interfaces/operations.md` (v4) §3.4, `interfaces/platform-and-product.md` (v6) §3.1

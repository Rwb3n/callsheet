# S8 Schema Foundation

**Phase:** 1B (Foundations)
**Agent:** Schema
**Written:** 2026-02-14
**Inputs:** `s8-pre-draft-checklist.md` §5, `s8-drafting/01-decisions.md` (D1, D2), `slice-01-data-model.md` §1–§2, `slice-04-subscriptions.md` §1, `slice-07-operations/00-schema.md`, `0-strategic-frame/output-style.md`

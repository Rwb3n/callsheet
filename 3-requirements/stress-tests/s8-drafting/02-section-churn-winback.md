# S8 §2 Churn Detection & Intervention / §3 Win-Back Evaluation & Delivery

**Phase:** 2 (Content)
**Agent:** B (Churn & Win-back)
**Written:** 2026-02-14
**Inputs:** `s8-drafting/01-decisions.md` (D1, D5, D6), `s8-drafting/01-schema.md` (commercial_state, churn_analysis_log), `s8-drafting/01-router-plan.md` (§2/§3 backend-only), `s8-pre-draft-checklist.md` (§3, §7), `interfaces/commercial-and-revenue.md` (v3 §1.2–§1.4, §5, §7, §8), `interfaces/shared-infrastructure.md` (v7 §1.2, §2.1, §9.2), `interfaces/operations.md` (v4 §1.2), `interfaces/data-and-listings.md` (v5 §3.2), `2-concept-design/commercial-and-revenue.md` (v4 §2.3, §2.4, §4.6)
